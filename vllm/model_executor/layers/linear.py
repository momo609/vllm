...
class AttnColumnParallelLinear(LinearBase):
    ...
    def __init__(
        ...
        *,
        ...
        self.tp_size = get_lm_tensor_model_parallel_world_size()
    ...
    def extra_repr(self) -> str:
        ...
        s += f", bias={self.bias is not None}"
        s += f", tp_size={get_lm_tensor_model_parallel_world_size()}"
        s += f", gather_output={self.gather_output}"
        return s


class AttnQKVParallelLinear(AttnColumnParallelLinear):
...
class AttnRowParallelLinear(LinearBase):
    ...
    def __init__(
        ...
        *,
        ...
        self.tp_rank = get_lm_tensor_model_parallel_rank()
        self.tp_size = get_lm_tensor_model_parallel_world_size()
